...
import { Search, SlidersHorizontal, Film, RotateCcw, Sparkles } from 'lucide-react';
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 pb-6 border-b border-[var(--theme-border)]">
          <div>
            ...
            <p className="text-xs text-theme-muted mt-1">
              Discover blockbuster Telugu hits, IMAX experiences, and premium Dolby Atmos screenings
            </p>
          </div>
          ...
          <div className="space-y-5 glass-panel rounded-3xl p-5 h-fit">
            <div className="flex items-center justify-between pb-3 border-b border-[var(--theme-border)]">
              ...
              <button
                ...
                className="flex items-center gap-1 text-[11px] font-bold text-theme-muted hover:text-pink-500 transition-colors"
              >
          ...
          <div className="lg:col-span-3">
            ...
            {filteredMovies.length === 0 ? (
              <div className="py-16 text-center glass-panel rounded-3xl">
                ...
                <button
                  onClick={resetFilters}
                  className="mt-4 px-5 py-2 rounded-xl bg-gradient-to-r from-pink-500 to-purple-600 text-xs font-black text-white shadow-md"
                >
                  Reset Filters
                </button>
              </div>
